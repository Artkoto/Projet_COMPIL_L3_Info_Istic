...
public class projetParser extends Parser {
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					match(input,22,FOLLOW_22_in_consts343); 
					pushFollow(FOLLOW_valeur_in_consts345);
					valeur();
					state._fsp--;

					PtGen.pt(670); 
					pushFollow(FOLLOW_ptvg_in_consts349);
					ptvg();
					state._fsp--;
	...
	public final void vars() throws RecognitionException {
		try {
			...
			{
			match(input,54,FOLLOW_54_in_vars368); 
			PtGen.pt(700); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_type_in_vars374);
					type();
					state._fsp--;
		...
		try {
			...
			switch (alt21) {
				case 1 :
					// .\\projet.g:80:87: vars
					{
					pushFollow(FOLLOW_vars_in_decproc476);
					vars();
					state._fsp--;
		...
		try {
			...
			switch (alt22) {
				case 1 :
					// .\\projet.g:83:9: ';'
					{
					match(input,18,FOLLOW_18_in_ptvg495); 
					}
					break;
				case 2 :
					// .\\projet.g:85:3: 
	...
	public final void parfixe() throws RecognitionException {
		try {
			...
			match(input,11,FOLLOW_11_in_parfixe544); 
			}
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_pm623); 
					pushFollow(FOLLOW_ident_in_pm625);
					ident();
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,18,FOLLOW_18_in_instructions649); 
	...
	public final void inssi() throws RecognitionException {
		try {
			...
			pushFollow(FOLLOW_expression_in_inssi717);
			expression();
			state._fsp--;
			...
			switch (alt29) {
				case 1 :
					...
					{
					match(input,52,FOLLOW_52_in_inssi726); 
					 PtGen.pt(1161); 
		...
		try {
			...
			switch (alt31) {
				case 1 :
					...
					{
					 PtGen.pt(1200); 
					match(input,26,FOLLOW_26_in_inscond807); 
					 PtGen.pt(1210); 
					pushFollow(FOLLOW_instructions_in_inscond811);
					instructions();
					state._fsp--;
			...
			match(input,39,FOLLOW_39_in_inscond829); 
			 PtGen.pt(1220); 
			}
	...
	public final void boucle() throws RecognitionException {
		try {
			...
			state._fsp--;
			 ...
			 PtGen.pt(1251); 
			match(input,36,FOLLOW_36_in_boucle853); 
	...
	public final void lecture() throws RecognitionException {
		try {
			...
			{
			match(input,43,FOLLOW_43_in_lecture872); 
			match(input,10,FOLLOW_10_in_lecture874); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_lecture882); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,14,FOLLOW_14_in_ecriture914); 
			...
			match(input,11,FOLLOW_11_in_ecriture923); 
			}
	...
	public final void affouappel() throws RecognitionException {
		try {
			...
			{
			pushFollow(FOLLOW_ident_in_affouappel939);
			ident();
			state._fsp--;
	...
	public final void effixes() throws RecognitionException {
		try {
			...
			match(input,11,FOLLOW_11_in_effixes1037); 
			}
	...
	public final void effmods() throws RecognitionException {
		try {
			...
			{
			match(input,10,FOLLOW_10_in_effmods1049); 
			...
			switch (alt40) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_ident_in_effmods1052);
					ident();
					state._fsp--;
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,14,FOLLOW_14_in_effmods1057); 
							pushFollow(FOLLOW_ident_in_effmods1059);
							ident();
							state._fsp--;
		...
		try {
			...
			switch (alt43) {
				...
				case 2 :
					// .\\projet.g:153:5: exp3
					{
					pushFollow(FOLLOW_exp3_in_exp21153);
					exp3();
					state._fsp--;
		...
		try {
			...
			switch (alt44) {
				...
				case 6 :
					// .\\projet.g:162:5: '<=' exp4
					{
					match(input,20,FOLLOW_20_in_exp31256); 
					PtGen.pt(1570);
		...
		try {
			...
			while (true) {
				...
				case 2 :
					...
					{
					match(input,15,FOLLOW_15_in_exp41318); 
					PtGen.pt(1570);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,12,FOLLOW_12_in_exp51367); 
					PtGen.pt(1570);
				...
				case 2 :
					...
					{
					match(input,32,FOLLOW_32_in_exp51391); 
					PtGen.pt(1570);
					pushFollow(FOLLOW_primaire_in_exp51395);
					primaire();
					state._fsp--;
		...
		try {
			...
			switch (alt47) {
				case 1 :
					...
					{
					pushFollow(FOLLOW_valeur_in_primaire1422);
					valeur();
					state._fsp--;
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_ident_in_primaire1431);
					ident();
					state._fsp--;
				...
				case 3 :
					...
					{
					match(input,10,FOLLOW_10_in_primaire1439); 
					pushFollow(FOLLOW_expression_in_primaire1441);
					expression();
					state._fsp--;

					match(input,11,FOLLOW_11_in_primaire1443); 
					}
					break;
		...
		try {
			...
			switch (alt48) {
				...
				case 2 :
					...
					{
					match(input,13,FOLLOW_13_in_valeur1465); 
				...
				case 3 :
					...
					{
					match(input,15,FOLLOW_15_in_valeur1475); 
					pushFollow(FOLLOW_nbentier_in_valeur1477);
					nbentier();
					state._fsp--;
				...
				case 5 :
					// .\\projet.g:187:5: 'faux'
					{
					match(input,38,FOLLOW_38_in_valeur1493); 
					 PtGen.pt(1870); 
					}
					break;
	...
	public final void nbentier() throws RecognitionException {
		...
		try {
			...
			// .\\projet.g:197:15: INT
			{
			INT1=(Token)match(input,INT,FOLLOW_INT_in_nbentier1523); 
	...
	public final void ident() throws RecognitionException {
		...
		try {
			...
			// .\\projet.g:199:9: ID
			{
			ID2=(Token)match(input,ID,FOLLOW_ID_in_ident1534); 
	...
	public static final BitSet FOLLOW_22_in_consts343 = new BitSet(new long[]{0x008000400000A040L});
	public static final BitSet FOLLOW_valeur_in_consts345 = new BitSet(new long[]{0x0000000000040020L});
	public static final BitSet FOLLOW_ptvg_in_consts349 = new BitSet(new long[]{0x0000000000000022L});
	public static final BitSet FOLLOW_54_in_vars368 = new BitSet(new long[]{0x0000000408000000L});
	public static final BitSet FOLLOW_type_in_vars374 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_vars_in_decproc476 = new BitSet(new long[]{0x0000000040000000L});
	public static final BitSet FOLLOW_corps_in_decproc479 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_18_in_ptvg495 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_11_in_parfixe544 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_type_in_pf558 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf560 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_14_in_pf566 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pf568 = new BitSet(new long[]{0x0000000000004002L});
	...
	public static final BitSet FOLLOW_14_in_pm623 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_pm625 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_instruction_in_instructions645 = new BitSet(new long[]{0x0000000000040002L});
	public static final BitSet FOLLOW_18_in_instructions649 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instruction_in_instructions651 = new BitSet(new long[]{0x0000000000040002L});
	...
	public static final BitSet FOLLOW_51_in_inssi715 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_inssi717 = new BitSet(new long[]{0x0000000002000000L});
	...
	public static final BitSet FOLLOW_52_in_inssi726 = new BitSet(new long[]{0x0028080210040020L});
	...
	public static final BitSet FOLLOW_26_in_inscond807 = new BitSet(new long[]{0x0028080210040020L});
	public static final BitSet FOLLOW_instructions_in_inscond811 = new BitSet(new long[]{0x0000008000000000L});
	public static final BitSet FOLLOW_39_in_inscond829 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_36_in_boucle853 = new BitSet(new long[]{0x0028080210040020L});
	...
	public static final BitSet FOLLOW_43_in_lecture872 = new BitSet(new long[]{0x0000000000000400L});
	public static final BitSet FOLLOW_10_in_lecture874 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_lecture876 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_lecture882 = new BitSet(new long[]{0x0000000000000020L});
	...
	public static final BitSet FOLLOW_14_in_ecriture914 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_ecriture916 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_11_in_ecriture923 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_affouappel939 = new BitSet(new long[]{0x0000000000020402L});
	...
	public static final BitSet FOLLOW_11_in_effixes1037 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_effmods1049 = new BitSet(new long[]{0x0000000000000820L});
	public static final BitSet FOLLOW_ident_in_effmods1052 = new BitSet(new long[]{0x0000000000004800L});
	public static final BitSet FOLLOW_14_in_effmods1057 = new BitSet(new long[]{0x0000000000000020L});
	public static final BitSet FOLLOW_ident_in_effmods1059 = new BitSet(new long[]{0x0000000000004800L});
	...
	public static final BitSet FOLLOW_exp3_in_exp21153 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_20_in_exp31256 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_15_in_exp41318 = new BitSet(new long[]{0x008000400000A460L});
	...
	public static final BitSet FOLLOW_12_in_exp51367 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51372 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_32_in_exp51391 = new BitSet(new long[]{0x008000400000A460L});
	public static final BitSet FOLLOW_primaire_in_exp51395 = new BitSet(new long[]{0x0000000100001002L});
	public static final BitSet FOLLOW_valeur_in_primaire1422 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ident_in_primaire1431 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_10_in_primaire1439 = new BitSet(new long[]{0x008040400000A460L});
	public static final BitSet FOLLOW_expression_in_primaire1441 = new BitSet(new long[]{0x0000000000000800L});
	public static final BitSet FOLLOW_11_in_primaire1443 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_nbentier_in_valeur1457 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_13_in_valeur1465 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1467 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_15_in_valeur1475 = new BitSet(new long[]{0x0000000000000040L});
	public static final BitSet FOLLOW_nbentier_in_valeur1477 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_55_in_valeur1485 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_38_in_valeur1493 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INT_in_nbentier1523 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ID_in_ident1534 = new BitSet(new long[]{0x0000000000000002L});
}
